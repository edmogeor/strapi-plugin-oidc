...
export interface PluginStrapiPluginOidcRoles extends Struct.CollectionTypeSchema {
  ...
  info: {
    collectionName: 'oidc-roles';
    description: '';
    displayName: 'oidc-role';
    pluralName: 'oidc-roles';
    singularName: 'roles';
  };
  options: {
    draftAndPublish: false;
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'plugin::strapi-plugin-oidc.roles'> &
      Schema.Attribute.Private;
...
export interface PluginStrapiPluginOidcWhitelists extends Struct.CollectionTypeSchema {
  collectionName: 'strapi-plugin-oidc_whitelists';
  info: {
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    email: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
